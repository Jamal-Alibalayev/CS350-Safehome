...
class CameraMonitor(tk.Toplevel):
    ...
    def _setup_gui(self):
        ...
        ttk.Label(info_frame, text=f"Location: {self.camera.location}").pack(
            anchor="w", padx=5
        )
        ...
        # Zoom buttons
        ttk.Button(control_frame, text="Zoom In (+)", command=self._zoom_in).grid(
            row=0, column=0, padx=5, pady=5
        )
        ttk.Button(control_frame, text="Zoom Out (-)", command=self._zoom_out).grid(
            row=0, column=2, padx=5, pady=5
        )

        # Pan buttons
        ttk.Button(control_frame, text="< Pan Left", command=self._pan_left).grid(
            row=1, column=0, padx=5, pady=5
        )
        ttk.Button(control_frame, text="Pan Right >", command=self._pan_right).grid(
